...
Welcome to ``selfiespredict`` contributor's guide.
...
If you experience bugs or general issues with ``selfiespredict``, please have a look
...
You can help improve ``selfiespredict`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``selfiespredict`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``selfiespredict``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n selfiespredict python=3 six virtualenv pytest pytest-cov
    conda activate selfiespredict
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/selfiespredict.git
    cd selfiespredict
...
#. Install |pre-commit|_::
   ...
   ``selfiespredict`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/selfiespredict
.. _issue tracker: https://github.com/<USERNAME>/selfiespredict/issues
.. <-- end -->
